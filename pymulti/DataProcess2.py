...
def get_max_along_r(interp_list, LR_r_list): # 取每条轴上的最大值，要用shock_wave_interval_interp的结果
...
def get_integrated_along_r(value_interp_list, rho_interp_list, LR_r_list): # 取每条轴上rho>RHO_EFFECT_RATIO*RHO_INITIAL_VALUE_FINE区域（即冲击波区域）
